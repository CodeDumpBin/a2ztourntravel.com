        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gallery">
          ...
          <?php echo $GALLERY_DESCRIPTION_1 ?>
            ...
            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-12">
                <div>
                  <a href="images/gallery/<?php echo $image ?>_big.jpg" data-lightbox="example-set" >
                   <img class="example-image" src="images/gallery/<?php echo $image; ?>.jpg" alt="<?php echo $GALLERY_IMAGES_ALT[$k]; ?>"/>
                  </a>
                </div>
            </div>            
            <?php endforeach; ?>
