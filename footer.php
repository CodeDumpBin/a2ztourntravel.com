            ...
            <div class="row">
                ...
                <h3 class="tz-title-bold-3"> Connect With Us</h3>
                    <form class="enquiryform" id="#">
                        ...
                        <div class="enquiryform text-center">
                            <button class="tz-view-more3" type="submit"><span>Send IT Now</span></button>
                        </div>
                    </form>
                </div>
            </div>
...
<div id="contact-slider" style="right:-342px;">
  ...
  <div id="header">
    ...
    <p>Write Your Message or Query</p>
   <form class="submit-form margin0" action="#">
          <div>
            <label>Name</label>
